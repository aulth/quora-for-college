...
const Navbar = () => {
  ...
  return (
    ...
    <div style={mode==='light'?{backgroundColor:lightBg, color:darkText}:{backgroundColor:darkBg, color:lightText}} className="c-container c-header c-d-flex c-bs-bb c-ai-center">
            ...
            <div id="c-search-bar" className="c-search-bar">
                <input style={mode==='light'?{backgroundColor:lightBg, color:darkText}:{backgroundColor:darkBg, color:lightText}}  id="c-search-input" className="c-h-45 c-bs-bb" type="search" placeholder="Search here"/>
            </div>
